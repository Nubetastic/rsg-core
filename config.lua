...
RSGConfig.Money = {}           -- Money that is not allowed going in minus
RSGConfig.Money.MoneyTypes = { cash = 200, gold = 0, bank = 0, valbank = 0, rhobank = 0, blkbank = 0, armbank = 0, bloodmoney = 0 } -- type = startamount - Add or remove money types for your server (for ex. blackmoney = 0), remember once added it will not be removed from the database!
...
RSGConfig.Gold = {}
RSGConfig.Gold.EnableGoldItems = false
